...
PREGUNTAS_BASE = [
    ...
    {
        "pregunta": "Briggs y Riccio (2007) estaban interesados en analizar si la extinción de una respuesta se veía afectada por la amnesia retrograda producida por eventos traumáticos. Para ello hicieron un estudio con seis grupos de ratas [...]. Con base en los datos, elige aquella opción que represente un hallazgo reportado por los autores.",
        "opciones": [
    ...
    {
        "pregunta": "Antonio es un estudiante de Psicología que [...] desarrolla una reacción de temor al ver o estar cerca de ratas. [...] Con el paso de las sesiones, las respuestas de miedo de Antonio disminuyen hasta prácticamente desaparecer. ¿Qué principio del aprendizaje explica este cambio en la conducta de Antonio?",
    ...
    {
        "pregunta": "Adriana es una gerente bancaria de 45 años que hace ocho meses fue diagnosticada con diabetes. [...] Con base en lo anterior, determina cuál es la dimensión psicológica del caso.",
        "opciones": [
    ...
    {
        "pregunta": "Luis es un estudiante universitario de 20 años que ha comenzado a reprobar varias materias. [...] Con base en lo anterior, determina cuál es la dimensión psicológica sobre la cual debe basarse el análisis psicológico.",
        "opciones": [
    ...
    {
        "pregunta": "El dueño de una compañía de ventas te contrata para intervenir con un gerente de producto [...]. Al entrevistarte con el gerente, ¿cuál de las siguientes preguntas consideras que te permitiría identificar la dimensión psicológica del problema?",
        "opciones": [
    ...
    {
        "pregunta": "Antonio es un niño de ocho años que acude a una escuela pública. [...] Con el propósito de analizar las principales variables que afectan el termino de sus actividades, elige aquel registro que pueda proporcionar la información más apropiada.",
    ...
    {
        "pregunta": "Carmen es una estudiante de medicina que, en situaciones de nerviosismo, presenta una conducta repetitiva de rascado en el brazo [...]. ¿Qué parámetro de registro conductual sería el más adecuado para evaluar esta conducta?",
        "opciones": [
    ...
    {
        "pregunta": "En un estudio experimental con 12 estudiantes universitarios con IMC en rango normopeso [...]. Con base en esta información, ¿cuál es el análisis más adecuado de las variables implicadas?",
        "opciones": [
    ...
    {
        "pregunta": "Armando es un peleador de muay thai que está por disputar un campeonato. [...] Considerando que la intervención debe orientarse a modificar las condiciones asociadas a la problemática, ¿cuál de los siguientes objetivos es el más adecuado?",
        "opciones": [
    ...
    {
        "pregunta": "Carla trabaja en atención al cliente y reporta altos niveles de estrés laboral. [...] Para evaluar el progreso de una intervención dirigida a modificar esta problemática, ¿cuál de los siguientes indicadores es el más adecuado?",
        "opciones": [
    ...
    {
        "pregunta": "Diego es un estudiante de preparatoria que presenta dificultades para participar en clase. [...] Con base en esta situación, ¿cuál de los siguientes procedimientos es el más adecuado para intervenir el problema?",
        "opciones": [
    ...
    {
        "pregunta": "Imagina que eres un psicólogo que trabaja en el ámbito educativo y recibes una solicitud para intervenir en la conducta de un niño que se levanta de su lugar de manera frecuente durante la clase. [...] Con base en esta situación, ¿cuál es el principio psicológico más adecuado para orientar la intervención?",
...
def init_state():
    defaults = {
        "pagina": "bienvenida",   # bienvenida | consentimiento | demograficos | autoevaluacion | preguntas | resultados
        "data": {},               # datos demográficos + autoevaluación + resumen
        "answers": [],            # lista de respuestas por pregunta
        "questions": [],          # preguntas barajadas
        "current_question": 0,
        "correct_answers": 0,
...
def vista_bienvenida():
    ...
    # Logo opcional
    try:
        st.image("image.png", width=180, use_container_width=False)
    except Exception:
        pass
...
def vista_consentimiento():
    st.markdown("<h1 style='text-align:center;'>Consentimiento Informado</h1>", unsafe_allow_html=True)

    st.markdown(f"""
    <div class="card">
        <p style="font-size:1.1rem; text-align:justify; color:{FG_TEXTO};">
            He sido informado del objetivo de la investigación, de mi participación, y del manejo
            confidencial de mis datos. Estoy de acuerdo en participar.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        if st.button("Sí, acepto 👍", use_container_width=True):
            ir_a("demograficos")
            st.rerun()
    with col2:
...
def vista_demograficos():
    st.markdown("<h1 style='text-align:center;'>Datos Demográficos</h1>", unsafe_allow_html=True)
...
def vista_preguntas():
    ...
    if "imagen_path" in q:
        try:
            st.image(q["imagen_path"], use_container_width=True)
        except Exception:
            st.warning(f"⚠️ Imagen no encontrada: {q['imagen_path']}")
